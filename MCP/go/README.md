# AIIMS, Patna MCP Server

This MCP (Model Content Protocol) server provides access to AIIMS, Patna API functionality through HTTP, HTTPS, and STDIO transport modes.
